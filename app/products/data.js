export const kitchens = [
  {
    ...
    price: '73,811 ₽',
    colors: '2',
    additional: ['praguekc1', 'praguekc2'],
  ...
  },
  {
    ...
    price: '119,000 ₽',
    colors: '1',
    additional: ['cataleyakc1', 'cataleyakc2', 'cataleyakc3'],
    description: 'Кухня Каталея не только красива, но и эргономична. Двери и ящики снабжены доводчиками. Вместительные шкафы и полки, помогают рационально организовать рабочее пространство. Модульная система адаптирует данный комплект под размеры любого помещения. Преобразите свой дом вместе с кухней Каталея.',
    metatitle: '',
    metadescription: ''
  },
  {
    ...
    price: '151,640 ₽',
    colors: '2',
    additional: ['inkantokc1', 'inkantokc2'],
    description: 'Кухня Инканто красива, изящна, и в то же самое время практична и комфортна - идеальный вариант для современного ритма жизни. Современный стиль в сочетании с неизменной практичностью исполнения.Кухня Инканто красива, изящна, и в то же самое время практична и комфортна - идеальный вариант для современного ритма жизни.',
    metatitle: '',
    metadescription: ''
  },
  {
  ...
  },
  {
    ...
    price: '131,514 ₽',
    colors: '2',
    additional: ['novakc1', 'novakc2', 'novakc3'],
  ...
  },
  {
    ...
    price: '123,954 ₽',
    colors: '2',
    additional: ['sanmarinokc1', 'sanmarinokc2', 'sanmarinokc3'],
  ...
  },
  {
    ...
    price: '161,496 ₽',
    colors: '2',
    additional: ['demetrakc1', 'demetrakc2', ],
...
export const offices = [
  {
    ...
    price: '74,500 ₽',
    colors: '2',
    additional: ['demetraof1', 'demetraof2'],
